(ns metabase.driver.dremio.generic-sql
...
(defn ISQLDriverDefaultsMixin
  ...
  []
  (require 'metabase.driver.dremio.generic-sql.query-processor)
  {:active-tables        fast-active-tables
   ...
   ;; the drivers
   :apply-source-table   (resolve 'metabase.driver.dremio.generic-sql.query-processor/apply-source-table)
   :apply-aggregation    (resolve 'metabase.driver.dremio.generic-sql.query-processor/apply-aggregation)
   :apply-breakout       (resolve 'metabase.driver.dremio.generic-sql.query-processor/apply-breakout)
   :apply-fields         (resolve 'metabase.driver.dremio.generic-sql.query-processor/apply-fields)
   :apply-filter         (resolve 'metabase.driver.dremio.generic-sql.query-processor/apply-filter)
   :apply-join-tables    (resolve 'metabase.driver.dremio.generic-sql.query-processor/apply-join-tables)
   :apply-limit          (resolve 'metabase.driver.dremio.generic-sql.query-processor/apply-limit)
   :apply-order-by       (resolve 'metabase.driver.dremio.generic-sql.query-processor/apply-order-by)
   :apply-page           (resolve 'metabase.driver.dremio.generic-sql.query-processor/apply-page)
...
(defn IDriverSQLDefaultsMixin
  ...
  (merge driver/IDriverDefaultsMixin
         {:can-connect?            can-connect?
          ...
          :execute-query           (resolve 'metabase.driver.dremio.generic-sql.query-processor/execute-query)
          :features                features
          :mbql->native            (resolve 'metabase.driver.dremio.generic-sql.query-processor/mbql->native)
